...
## 1. 이 <span style="color:blueviolet"> 프로젝트 </span>의 전체 흐름을 보아 <span style="color:#00FF00"> 장단점 </span> 은 무엇이라 생각하는가?
- 장점 <br>
...
## 2. https가 아닌 http에서의 보안 기능을 <span style="color:orange"> 왜 </span> 배운다고 생각하는가?
